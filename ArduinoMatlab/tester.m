...
% Last Modified by GUIDE v2.5 07-Apr-2013 16:45:56
...
global a;
a = arduino('COM9');
a.pinMode(13,'output') % sets digital pin #13 as output
a.pinMode(12,'output') % sets digital pin #12 as output
...
a.digitalWrite(12,1); % sets pin #12 high
...
% handles    structure with handles and user data (see GUIDATA)
global a;
a.digitalWrite(13,0); % sets pin #13 high
a.digitalWrite(12,0); % sets pin #12 high
